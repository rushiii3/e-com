                ...
                <form className='space-y-6' onSubmit={handleSubmit}>
                    ...
                    <div>
                        <div className='flex items-center justify-between'>
                            ...
                            <input type="checkbox" name="remember-me" id="remember-me" className='h-4 w-4 text-blue-400 focus:ring-blue-500 border-gray-300 rounded' />
                                <label htmlFor="remember-me" className='ml-2 block text-sm text-gray-900'>Remember Me</label>
                                    ...
                                    <a href='.forgot-password' className='text-sm ml-auto font-medium text-blue-500 hover:text-blue-700'>
                                        Forgot Password?
                                    </a>
